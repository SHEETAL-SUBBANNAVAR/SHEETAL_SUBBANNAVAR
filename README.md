...
🤝 Looking for help with: **Improving DSA, backend logic, and interview preparation**
...
* Focused on **DOM manipulation and UI logic**

### 🤖 SkillSync AI *(In Progress)*

* AI-powered career guidance platform
* Goal: Help users achieve high-paying tech jobs
